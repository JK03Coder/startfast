  ...
  <footer class="bg-white">
    ...
    >
      <div class="grid sm:grid-cols-2 gap-8 lg:grid-cols-3">
        <div>
          <div class="text-primary font-black text-3xl">LOGO</div>

          <p class="mt-4 max-w-xs text-slate-500">
          ...
          <ul class="mt-8 flex gap-6">
            <li>
              <a
                ...
                rel="noreferrer"
                target="_blank"
                class="text-slate-700 transition hover:opacity-75"
              >
        ...
        <div
          class="grid gap-8 grid-cols-2 lg:col-span-2 lg:grid-cols-4"
        >

          {#snippet linkSection(sectionTitle: string, links: {name: string, link: string}[])}
            <div>
              <p class="font-medium text-slate-900">{sectionTitle}</p>

              <ul class="mt-6 space-y-4 text-sm">
                {#each links as {name, link}}
                <li>
                  <a href={link} class="text-slate-700 transition hover:opacity-75">
                    {name}
                  </a>
                </li>
                {/each}
          ...
          {@render linkSection("Services", [
            {name: "1on1 Coaching", link: "/"}, 
            {name: "Company Review", link:  "/"}, 
            {name: "Accounts Review", link: "/"}, 
            {name: "HR Consulting", link:  "/"}, 
            {name: "SEO Optimisation", link:  "/"}
          ])}

          {@render linkSection("Company", [
            {name: "About", link: "/"}, 
            {name: "Meet the Team", link:  "/"}, 
            {name: "Accounts Review", link: "/"}
          ])}

          {@render linkSection("Helpful Links", [
            {name: "Contact", link: "/"}, 
            {name: "FAQs", link:  "/"}, 
            {name: "Live Chat", link: "/"}
          ])}

          {@render linkSection("Legal", [
            {name: "Accessibility", link: "/"}, 
            {name: "Returns Policy", link:  "/"}, 
            {name: "Refund Policy", link: "/"},
            {name: "Hiring Statistics", link: "/"}
          ])}
